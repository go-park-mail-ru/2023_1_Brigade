...
func main() {
	...
	//consumer.NewConsumerServiceGRPCClient(grpcConnConsumer)
	...
	messagesUsecase := usecaseMessages.NewMessagesUsecase(chatRepo, messagesRepo, consumerService, producerUsecase)
