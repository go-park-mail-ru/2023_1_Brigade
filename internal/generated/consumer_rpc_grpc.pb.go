...
type ConsumerClient interface {
	ConsumeMessage(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*Bytes, error)
	StartConsumeMessages(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*emptypb.Empty, error)
}
...
func (c *consumerClient) ConsumeMessage(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*Bytes, error) {
	out := new(Bytes)
...
func (c *consumerClient) StartConsumeMessages(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*emptypb.Empty, error) {
...
type ConsumerServer interface {
	ConsumeMessage(context.Context, *emptypb.Empty) (*Bytes, error)
	StartConsumeMessages(context.Context, *emptypb.Empty) (*emptypb.Empty, error)
...
func (UnimplementedConsumerServer) ConsumeMessage(context.Context, *emptypb.Empty) (*Bytes, error) {
	return nil, status.Errorf(codes.Unimplemented, "method ConsumeMessage not implemented")
}
func (UnimplementedConsumerServer) StartConsumeMessages(context.Context, *emptypb.Empty) (*emptypb.Empty, error) {
...
func _Consumer_ConsumeMessage_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ConsumerServer).ConsumeMessage(ctx, req.(*emptypb.Empty))
	}
...
func _Consumer_StartConsumeMessages_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ConsumerServer).StartConsumeMessages(ctx, req.(*emptypb.Empty))
	}
	return interceptor(ctx, in, info, handler)
}
