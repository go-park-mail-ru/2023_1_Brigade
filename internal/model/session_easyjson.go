...
func easyjsonA818f49aDecodeProjectInternalModel(in *jlexer.Lexer, out *Session) {
...
func easyjsonA818f49aEncodeProjectInternalModel(out *jwriter.Writer, in Session) {
	out.RawByte('{')
	first := true
	_ = first
	{
...
func (v Session) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjsonA818f49aEncodeProjectInternalModel(&w, v)
...
func (v *Session) UnmarshalJSON(data []byte) error {
	...
	easyjsonA818f49aDecodeProjectInternalModel(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *Session) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjsonA818f49aDecodeProjectInternalModel(l, v)
}
